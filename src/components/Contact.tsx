...
export function Contact() {
  ...
  const contacts = [
    ...
    {
      name: "Email",
      description: "flavio.lima981@gmail.com",
      link: "mailto:flavio.lima981@gmail.com?subject=Olá...",
      icon: <HiOutlineEnvelope className="h-10 w-10" />,
    },
    {
      name: "Rio De Janeiro",
      description: "Nova Friburgo",
      link: "https://www.google.com/maps/place/Nova+Friburgo,+RJ/@-22.2809342,-42.5329603,12z/data=!3m1!4b1!4m6!3m5!1s0x978a936f151283:0xff2b16c0bfb117c4!8m2!3d-22.2887261!4d-42.5340796!16zL20vMDJscjN3?entry=ttu",
          ...
          <div className="basis-2/3">
            <form ref={form} onSubmit={sendEmail}>
              ...
              <div className="mb-4">
                ...
                <label htmlFor="message" className="mb-2 block ps-4 font-headline font-semibold">Mensagem:</label>
                <textarea name="message" id="message" className="h-36 w-full rounded-lg border border-white bg-transparent p-2 outline-none" required></textarea>

              </div>

              <div className="mb-6 flex flex-col gap-4 md:flex-row">
                <div className="flex-grow">
                  <label htmlFor="fullName" className="mb-2 block ps-4 font-headline font-semibold">Seu nome:</label>
                  <input
